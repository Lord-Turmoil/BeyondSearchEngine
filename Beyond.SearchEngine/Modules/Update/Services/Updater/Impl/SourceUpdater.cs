...
public class SourceUpdater
    : GenericUpdater<SourceIndexer, ElasticSource, SourceDtoBuilder, SourceDto>
{
    public SourceUpdater(IUnitOfWork unitOfWork, IMapper mapper, ILogger<UpdateTask> logger,
